      ...
      <div class="account-container" >
        <div v-for="item in accounts"class="account-wrap">
              <div style="height:25px;"v-html="SvgIconMap[item.accountType]"></div>
                 <p class="card-number">{{item.accountId}}</span>
...
<style lang="less">
  ...
  .account-wrap {
    width:23%;background-color:#e0e2e6;display:inline-block;padding:4px;
    margin: 4px 0px 4px 5px;
    vertical-align: top;

  }
  .card-number {
    font-size:1px;width:100%;word-wrap:break-word;word-break:break-all;
    height:32px;
  }
