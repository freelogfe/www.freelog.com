    ...
    methods: {
      ...
      tagState(html) {
        ...
        html = html.replace(reg, ($, $1) => {
          ...
          var html = `<span class="from-state ${cls}" data-action="info" data-state="${$1}">${$$}<i class="el-icon-fa-stop-circle-o cur-step-icon"></i><span class="state-tip">当前合同状态</span></span>`
